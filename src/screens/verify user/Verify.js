                    ...
                    <div className="col-md-6">
                      <div className="verify-left">
                        <div className="verify-left-overlay">
                          ...
                          <h3 className="mb-3 ml-3">Por favor, verifica tu cuenta</h3>
                          </div>
                          ...
                          <button type="submit" className="verify-btn">
                            Verificar {loader && <MiniLoader />}
                        </button>
                        <p className="ml-5" style={{color: "#ffffff"}}>No eres miembro? <Link style={{color: "#ffffff"}} to="/register">Registrar aquí</Link></p>
                        </div>
                      </div>
                    </div>
